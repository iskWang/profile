      ...
      <div className="mx-auto grid max-w-7xl gap-4 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="rounded-[2rem] border border-black bg-[#111111] p-5 text-white shadow-[8px_8px_0_#111111] sm:p-8 lg:min-h-[590px]">
          <div className="mb-12 flex items-center justify-between gap-4">
            <span className="rounded-full border border-white/15 px-3 py-1 text-xs font-black uppercase tracking-[0.22em] text-white/82">
              {hero.location}
            </span>
          ...
          <h1 className="max-w-4xl text-5xl font-black leading-[0.9] tracking-[-0.05em] text-white sm:text-7xl lg:text-8xl">
            {hero.name}
            <span className="block text-white/82 text-[0.72em] leading-[0.98] tracking-[-0.055em] sm:text-[0.68em] lg:text-[0.62em]">{hero.slogan}</span>
          </h1>
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex min-h-[48px] items-center rounded-full bg-white px-5 text-sm font-black uppercase tracking-[0.14em] text-black transition hover:-translate-y-1 hover:bg-[#dff8ff] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            >
              {hero.resumeBtn}
            </a>
            <a
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          {hero.metrics.map((metric) => (
            <div key={metric.label} className="bento-card bg-white p-5">
