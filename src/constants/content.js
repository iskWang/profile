      ...
      items: [
        {
          ...
          highlights: [
            "一週內完成完整 POC：整合 browser agent、LLM pipeline、self-healing 與全端架構",
            "設計兩階段 LLM 流程：Stagehand 探索網頁記錄 ActionLog，自動生成 Gherkin 檔與 Playwright 測試腳本",
            "實作 Self-healing 機制：測試失敗時由 LLM 自動修復 selector 與 timeout 並重試，提升可用率",
            "全端 monorepo 架構：React/Vite、Fastify/Node.js、BullMQ/Redis、Docker Compose，產出物 runtime 無 LLM 依賴",
          ],
        },
      ],
    },
