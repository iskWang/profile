      ...
      items: [
        {
          ...
          tags: ["AI Agent", "E2E Testing", "LLM", "Open Source"],
          highlights: [
            "Completed full POC in one week using AI-assisted workflow: browser agent, LLM pipeline, self-healing, and full-stack architecture.",
            ...
            "Implemented self-healing mechanism: on test failure, LLM auto-patches selectors and timeouts and retries, improving test usability.",
            "Full-stack architecture: React/Vite, Fastify/Node.js, BullMQ/Redis, Docker Compose; zero LLM dependency at runtime.",
          ],
        },
      ],
    },
